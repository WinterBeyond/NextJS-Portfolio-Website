	...
	return [
		{
			id: "cypoint",
			description:
				"Working on a product information management system called Inriver, I create extensions and templates to allow the customer to more easily enrich their products.",
